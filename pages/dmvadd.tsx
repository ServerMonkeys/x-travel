...
import {addDMV} from "../helper/fetchData";
...
function DMVadd() {
    ...
    const handleSubmit = async (event:any) => {
        ...
        await addDMV(ssn,fname.toUpperCase(),lname.toUpperCase(),dob,dl,phone,street,city,state,zip,country,imageSrc);
                    ...
                    <div className="grid md:grid-cols-2 md:gap-6">
                        ...
                        <div className="relative z-0 mb-6 w-full group">
                            <input type="text" name="dl" id="dl"
                                   ...
                                   minLength={8}
                                   maxLength={8}
                                   onChange={({target}) => updateDL(target?.value)}/>
                            <label htmlFor="dl"
                                   className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">
